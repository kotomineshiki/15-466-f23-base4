...
struct LitColorTextureTransProgram
{
	LitColorTextureTransProgram();
	~LitColorTextureTransProgram();
...
extern Load<LitColorTextureTransProgram> lit_color_texture_trans_program;
...
extern Scene::Drawable::Pipeline lit_color_texture_trans_program_pipeline;
